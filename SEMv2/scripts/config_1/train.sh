...
export NNODES=1
export cfg=config_1
export work_dir=/work1/cv1/jszhang6/TSR/code/SEMv2/AblationStudy_on_SEMv2/M17/experiments/config_1
...
if [[ $NNODES -gt 1 ]]; then
	...
	python -m torch.distributed.launch --nproc_per_node=$NGPUS --master_port=10017 \
        train.py --cfg $cfg --work_dir $work_dir
fi
